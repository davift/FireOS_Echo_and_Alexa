...
#ifdef DHCP_HIDE_HOSTNAME
	  log_packet("DHCPACK", &mess->yiaddr, emac, emac_len, iface_name, NULL, mess->xid);
#else
...
/* fosmod_wifi_bug_fix begin */
#ifdef DHCP_HIDE_HOSTNAME
      // Hostname contains client device info, hide it for user build
