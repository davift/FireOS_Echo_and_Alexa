							...
							char autosort)
{
	...
	*/
		...
		init_proc_prints();
			...
			"VDATA:4 VSTACK:4 VSIZE:6 RSIZE:7 PSIZE:5 USIZE:5"
			...
			"ST:6 EXC:6 S:6 SORTITEM:10 CMD:10", 
                ...
                make_proc_prints(totusers, MAXITEMS, 
                        ...
                        "RSIZE:8 PSIZE:8 USIZE:8 SWAPSZ:5 RDDSK:7 CWRDSK:7 "
...
int
comptask(const void *a, const void *b)
{
        register count_t acpu = ((struct tstat *)a)->cpu.stime +
                                ((struct tstat *)a)->cpu.utime;
        register count_t bcpu = ((struct tstat *)b)->cpu.stime +
...
int
comptaskptr(const void *a, const void *b)
{
     return comptask(*(struct tstat **)a, *(struct tstat **)b);
}
