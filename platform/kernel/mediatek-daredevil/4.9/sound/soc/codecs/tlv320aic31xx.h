...
#define AIC31XX_FREQ_1536000			1536000

#define AIC31XX_PLLCLKIN			0x03
#define AIC31XX_BCLKCLKIN			0x01
#define AIC31XX_PLLEN				(0x01 << 7)
#define AIC31XX_NDACEN				(0x01 << 7)
#define AIC31XX_MDACEN				(0x01 << 7)
#define AIC31XX_NADCEN				(0x01 << 7)
#define AIC31XX_MADCEN				(0x01 << 7)
#define AIC31XX_BCLKEN				(0x01 << 7)
