...
static void mtk_i2c_init_hw(struct mtk_i2c *i2c)
{
	...
	if (i2c->dev_comp->dcm && !i2c->enable_multi_user)
...
static void i2c_dump_register(struct mtk_i2c *i2c)
{
	...
	if (!i2c->enable_multi_user)
		dev_err(i2c->dev, "DCM_EN: 0x%x\n",
...
static int mtk_i2c_parse_dt(struct device_node *np, struct mtk_i2c *i2c)
{
	...
	i2c->enable_multi_user =
		of_property_read_bool(np, "mediatek,enable-multi-user");
