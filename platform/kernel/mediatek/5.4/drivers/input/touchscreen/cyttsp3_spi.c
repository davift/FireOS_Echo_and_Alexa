/*
 * Source for:
 * Parade (Cypress) TrueTouch(TM) Standard Product (TTSP) SPI touchscreen driver.
 ...
 * CY8CTMA340
 *
 * Copyright (C) 2015-2017 Parade Technologies, Inc.
 ...
 *
 * Contact Parade Technologies at www.paradetech.com
 *
 */
