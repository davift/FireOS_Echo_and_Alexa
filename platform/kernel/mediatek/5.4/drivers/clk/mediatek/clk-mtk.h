...
#define DIV_GATE(_id, _name, _parent, _gate_reg, _gate_shift, _div_reg,	\
	...
	DIV_GATE_FLAGS(_id, _name, _parent, _gate_reg, _gate_shift, _div_reg,	\
					_div_width, _div_shift, 0)

#define DIV_GATE_FLAGS(_id, _name, _parent, _gate_reg, _gate_shift, _div_reg,	\
					_div_width, _div_shift, _flags) {	\
		.id = _id,						\
		.parent = _parent,					\
		.name = _name,						\
