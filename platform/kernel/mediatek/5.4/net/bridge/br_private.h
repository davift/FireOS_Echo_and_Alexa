...
struct net_bridge {
	...
	struct br_eero_net_bridge_nf_ext eero_nf_ext;
#endif
#endif
	u16				group_fwd_mask;
...
#ifdef CONFIG_BIFROST_MESH
	struct br_eero_net_bridge_ext eero_ext;
#endif
};
...
bool br_eero_should_drop_frame(struct net_bridge const *br,
                               struct sk_buff *skb);
#else
static inline bool br_eero_should_drop_frame(struct net_bridge const *br, struct sk_buff *skb)
{
	return false;
}
...
#ifdef CONFIG_BIFROST_MESH
/* eero Change
 * This allows us to drop looping frames if br_fdb_update detects ones.
 */
...
#ifdef CONFIG_BIFROST_MESH
void br_eero_flood_forward(struct net_bridge *br, struct sk_buff *skb,
                      enum br_pkt_type pkt_type, bool local_rcv, bool local_orig);
#else
static inline void br_eero_flood_forward(struct net_bridge *br, struct sk_buff *skb,
                      enum br_pkt_type pkt_type, bool local_rcv, bool local_orig)
{
	br_flood(br, skb, pkt_type, local_rcv, local_orig);
}
#endif
