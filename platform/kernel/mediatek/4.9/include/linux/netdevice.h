...
#ifdef CONFIG_BIFROST_MESH
/* A tag denoting what type of extensions are embedded in the net_device. */
enum net_device_ext_tag {
	NET_DEVICE_EXT_NONE = 0,
	NET_DEVICE_EXT_EERO,
};
typedef enum net_device_ext_tag net_device_ext_tag_t;
#endif
...
#ifdef CONFIG_BIFROST_MESH
	net_device_ext_tag_t device_ext_tag;
	union {
		eero_net_device_ext_t eero;
	} device_ext;
#endif
};
