...
DEFINE_EVENT(wiphy_netdev_evt, rdev_get_mesh_eero_ext_config,
	TP_PROTO(struct wiphy *wiphy, struct net_device *netdev),
	TP_ARGS(wiphy, netdev)
);
#endif
...
TRACE_EVENT(rdev_add_mpp,
	...
	TP_printk(WIPHY_PR_FMT ", " NETDEV_PR_FMT ", destination: "
...
#ifdef CONFIG_BIFROST_MESH
TRACE_EVENT(rdev_update_mesh_eero_ext_config,
	TP_PROTO(struct wiphy *wiphy, struct net_device *netdev, u32 mask,
		 const struct mesh_config *conf),
	TP_ARGS(wiphy, netdev, mask, conf),
	TP_STRUCT__entry(
