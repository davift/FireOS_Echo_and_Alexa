...
#else
static inline int validate_beacon_head(const struct nlattr *attr)
{
	return 0;
}
#endif
...
#ifdef CONFIG_BIFROST_MESH
	/* from upstream patch */
	[NL80211_ATTR_BANDS] = { .type = NLA_U8 },
#else
...
#ifdef CONFIG_BIFROST_MESH
		CMD(update_mesh_eero_ext_config, SET_MESH_EERO_EXT_CONFIG);
#endif
				...
				struct mpath_info *pinfo)
{
...
#ifdef CONFIG_BIFROST_MESH
	if (pinfo->filled & MPATH_INFO_IFINDEX)
		ifindex = pinfo->ifindex;
	...
	if (((pinfo->filled & MPATH_INFO_SN) &&
	    ...
	    ((pinfo->filled & MPATH_INFO_HOPCOUNT) &&
			      ...
			      struct netlink_callback *cb)
{
	...
	if (wdev->netdev->ieee80211_ptr->iftype != NL80211_IFTYPE_MESH_POINT) {
		err = -EOPNOTSUPP;
		goto out_err;
	}
...
#ifdef CONFIG_BIFROST_MESH
static int nl80211_new_mpp(struct sk_buff *skb, struct genl_info *info)
{
	struct cfg80211_registered_device *rdev = info->user_ptr[0];
	struct net_device *dev = info->user_ptr[1];
	u8 *dest = NULL;
	...
	proxy = nla_data(info->attrs[NL80211_ATTR_MPATH_NEXT_HOP]);
	...
	return rdev_add_mpp(rdev, dev, dest, proxy);
}
#endif
				   ...
				   struct genl_info *info)
{
	...
	if (nla_put_u32(msg, NL80211_ATTR_IFINDEX, dev->ifindex) ||
	    nla_put_u16(msg, NL80211_MESHCONF_RETRY_TIMEOUT,
			cur_params.ifcfg.dot11MeshRetryTimeout) ||
	    nla_put_u16(msg, NL80211_MESHCONF_CONFIRM_TIMEOUT,
			cur_params.ifcfg.dot11MeshConfirmTimeout) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HOLDING_TIMEOUT,
			cur_params.ifcfg.dot11MeshHoldingTimeout) ||
	    nla_put_u16(msg, NL80211_MESHCONF_MAX_PEER_LINKS,
			cur_params.ifcfg.dot11MeshMaxPeerLinks) ||
	    nla_put_u8(msg, NL80211_MESHCONF_MAX_RETRIES,
		       cur_params.ifcfg.dot11MeshMaxRetries) ||
	    nla_put_u8(msg, NL80211_MESHCONF_FORWARDING,
		       cur_params.ifcfg.dot11MeshForwarding) ||
	    nla_put_u8(msg, NL80211_MESHCONF_TTL,
		       cur_params.mbsscfg.dot11MeshTTL) ||
	    nla_put_u8(msg, NL80211_MESHCONF_ELEMENT_TTL,
		       cur_params.mbsscfg.element_ttl) ||
	    nla_put_u8(msg, NL80211_MESHCONF_AUTO_OPEN_PLINKS,
		       cur_params.ifcfg.auto_open_plinks) ||
	    nla_put_u32(msg, NL80211_MESHCONF_SYNC_OFFSET_MAX_NEIGHBOR,
			cur_params.ifcfg.dot11MeshNbrOffsetMaxNeighbor) ||
	    nla_put_u8(msg, NL80211_MESHCONF_HWMP_MAX_PREQ_RETRIES,
		       cur_params.mbsscfg.dot11MeshHWMPmaxPREQretries) ||
	    nla_put_u32(msg, NL80211_MESHCONF_PATH_REFRESH_TIME,
			cur_params.mbsscfg.path_refresh_time) ||
	    nla_put_u16(msg, NL80211_MESHCONF_MIN_DISCOVERY_TIMEOUT,
			cur_params.mbsscfg.min_discovery_timeout) ||
	    nla_put_u32(msg, NL80211_MESHCONF_HWMP_ACTIVE_PATH_TIMEOUT,
			cur_params.mbsscfg.dot11MeshHWMPactivePathTimeout) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_PREQ_MIN_INTERVAL,
			cur_params.mbsscfg.dot11MeshHWMPpreqMinInterval) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_PERR_MIN_INTERVAL,
			cur_params.mbsscfg.dot11MeshHWMPperrMinInterval) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_NET_DIAM_TRVS_TIME,
			cur_params.mbsscfg.dot11MeshHWMPnetDiameterTraversalTime) ||
	    nla_put_u8(msg, NL80211_MESHCONF_HWMP_ROOTMODE,
		       cur_params.mbsscfg.dot11MeshHWMPRootMode) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_RANN_INTERVAL,
			cur_params.mbsscfg.dot11MeshHWMPRannInterval) ||
	    nla_put_u8(msg, NL80211_MESHCONF_GATE_ANNOUNCEMENTS,
		       cur_params.mbsscfg.dot11MeshGateAnnouncementProtocol) ||
	    nla_put_u32(msg, NL80211_MESHCONF_RSSI_THRESHOLD,
			cur_params.ifcfg.rssi_threshold) ||
	    nla_put_u32(msg, NL80211_MESHCONF_HT_OPMODE,
			cur_params.ifcfg.ht_opmode) ||
	    nla_put_u32(msg, NL80211_MESHCONF_HWMP_PATH_TO_ROOT_TIMEOUT,
			cur_params.mbsscfg.dot11MeshHWMPactivePathToRootTimeout) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_ROOT_INTERVAL,
			cur_params.mbsscfg.dot11MeshHWMProotInterval) ||
	    nla_put_u16(msg, NL80211_MESHCONF_HWMP_CONFIRMATION_INTERVAL,
			cur_params.mbsscfg.dot11MeshHWMPconfirmationInterval) ||
	    nla_put_u32(msg, NL80211_MESHCONF_POWER_MODE,
			cur_params.ifcfg.power_mode) ||
	    nla_put_u16(msg, NL80211_MESHCONF_AWAKE_WINDOW,
			cur_params.ifcfg.dot11MeshAwakeWindowDuration) ||
	    nla_put_u32(msg, NL80211_MESHCONF_PLINK_TIMEOUT,
			cur_params.ifcfg.plink_timeout))
		goto nla_put_failure;
#else
	if (nla_put_u32(msg, NL80211_ATTR_IFINDEX, dev->ifindex) ||
	    nla_put_u16(msg, NL80211_MESHCONF_RETRY_TIMEOUT,
...
#ifdef CONFIG_BIFROST_MESH
static int nl80211_get_mesh_eero_ext_config(struct sk_buff *skb,
				   struct genl_info *info)
{
	struct cfg80211_registered_device *rdev = info->user_ptr[0];
	struct net_device *dev = info->user_ptr[1];
	...
	if (!rdev->ops->get_mesh_eero_ext_config)
		return -EOPNOTSUPP;
	...
	if (!wdev->mesh_id_len)
		...
		err = rdev_get_mesh_eero_ext_config(rdev, dev, &cur_params);
	wdev_unlock(wdev);
	...
	if (!msg)
		return -ENOMEM;
	hdr = nl80211hdr_put(msg, info->snd_portid, info->snd_seq, 0,
			     NL80211_CMD_GET_MESH_EERO_EXT_CONFIG);
	if (!hdr)
		goto out;
	pinfoattr = nla_nest_start(msg, NL80211_ATTR_MESH_EERO_EXT_CONFIG);
	if (!pinfoattr)
		goto nla_put_failure;
	if (nla_put_u32(msg, NL80211_ATTR_IFINDEX, dev->ifindex) ||
	    nla_put_u8(msg, NL80211_MESHCONF_EERO_BIFROST_VER,
			cur_params.mbsscfg.bifrost_ver) ||
	    nla_put_u8(msg, NL80211_MESHCONF_EERO_UNIMCAST,
			cur_params.mbsscfg.unimcast))
	{
		goto nla_put_failure;
	}
	nla_nest_end(msg, pinfoattr);
...
#ifdef CONFIG_BIFROST_MESH
static const struct nla_policy nl80211_meshconf_eero_ext_params_policy[NL80211_MESHCONF_EERO_ATTR_MAX+1] = {
	[NL80211_MESHCONF_EERO_BIFROST_VER] = { .type = NLA_U8 },
	[NL80211_MESHCONF_EERO_UNIMCAST] = { .type = NLA_U8 },
};
#endif
...
#ifdef CONFIG_BIFROST_MESH
	[NL80211_MESH_SETUP_MESH_ADDR] = { .type = NLA_BINARY,
					   .len = ETH_ALEN},
#endif
};
...
#ifdef CONFIG_BIFROST_MESH
#define FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, param, min, max,		    \
				     mask, attr, fn)			    \
	FILL_IN_MESH_PARAM_IF_SET(tb, cfg, ifcfg.param, min, max,	    \
				  mask, attr, fn)

#define FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, param, min, max,		    \
				      mask, attr, fn)			    \
	FILL_IN_MESH_PARAM_IF_SET(tb, cfg, mbsscfg.param, min, max,	    \
				  mask, attr, fn)
#endif
...
#ifdef CONFIG_BIFROST_MESH
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshTTL, 1, 255,
				  mask, NL80211_MESHCONF_TTL, nl80211_check_u8);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, element_ttl, 1, 255,
				  mask, NL80211_MESHCONF_ELEMENT_TTL,
				  nl80211_check_u8);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPmaxPREQretries, 0, 255,
				  mask, NL80211_MESHCONF_HWMP_MAX_PREQ_RETRIES,
				  nl80211_check_u8);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, path_refresh_time, 1, 65535,
				  mask, NL80211_MESHCONF_PATH_REFRESH_TIME,
				  nl80211_check_u32);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, min_discovery_timeout, 1, 65535,
				  mask, NL80211_MESHCONF_MIN_DISCOVERY_TIMEOUT,
				  nl80211_check_u16);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPactivePathTimeout,
				      1, 0xffffffff, mask,
				  NL80211_MESHCONF_HWMP_ACTIVE_PATH_TIMEOUT,
				  nl80211_check_u32);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPpreqMinInterval,
				  1, 65535, mask,
				  NL80211_MESHCONF_HWMP_PREQ_MIN_INTERVAL,
				  nl80211_check_u16);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPperrMinInterval,
				  1, 65535, mask,
				  NL80211_MESHCONF_HWMP_PERR_MIN_INTERVAL,
				  nl80211_check_u16);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg,
				  dot11MeshHWMPnetDiameterTraversalTime,
				  1, 65535, mask,
				  NL80211_MESHCONF_HWMP_NET_DIAM_TRVS_TIME,
				  nl80211_check_u16);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPRootMode, 0, 4,
				  mask, NL80211_MESHCONF_HWMP_ROOTMODE,
				  nl80211_check_u8);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPRannInterval, 1, 65535,
	...
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg,
				  ...
				  nl80211_check_bool);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshForwarding, 0, 1,
				  mask, NL80211_MESHCONF_FORWARDING,
				  nl80211_check_bool);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMPactivePathToRootTimeout,
				      1, 0xffffffff, mask,
				      NL80211_MESHCONF_HWMP_PATH_TO_ROOT_TIMEOUT,
				      nl80211_check_u32);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, dot11MeshHWMProotInterval, 1, 65535,
	...
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg,
				      ...
				      nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshRetryTimeout, 1, 255,
				     mask, NL80211_MESHCONF_RETRY_TIMEOUT,
				     nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshConfirmTimeout, 1, 255,
				     mask, NL80211_MESHCONF_CONFIRM_TIMEOUT,
				     nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshHoldingTimeout, 1, 255,
				     mask, NL80211_MESHCONF_HOLDING_TIMEOUT,
				     nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshMaxPeerLinks, 0, 255,
				     mask, NL80211_MESHCONF_MAX_PEER_LINKS,
				     nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshMaxRetries, 0, 16,
				     mask, NL80211_MESHCONF_MAX_RETRIES,
				     nl80211_check_u8);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, auto_open_plinks, 0, 1,
				     mask, NL80211_MESHCONF_AUTO_OPEN_PLINKS,
				     nl80211_check_bool);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshNbrOffsetMaxNeighbor,
				     1, 255, mask,
				     NL80211_MESHCONF_SYNC_OFFSET_MAX_NEIGHBOR,
				     nl80211_check_u32);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, rssi_threshold, -255, 0,
...
#ifdef CONFIG_BIFROST_MESH
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, power_mode,
				  NL80211_MESH_POWER_ACTIVE,
				  NL80211_MESH_POWER_MAX,
				  mask, NL80211_MESHCONF_POWER_MODE,
				  nl80211_check_power_mode);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, dot11MeshAwakeWindowDuration,
				  0, 65535, mask,
				  NL80211_MESHCONF_AWAKE_WINDOW, nl80211_check_u16);
	FILL_IN_MESH_IF_PARAM_IF_SET(tb, cfg, plink_timeout, 0, 0xffffffff,
...
#ifdef CONFIG_BIFROST_MESH
#undef FILL_IN_MESH_IF_PARAM_IF_SET
#undef FILL_IN_MESH_BSS_PARAM_IF_SET
#endif
}

#ifdef CONFIG_BIFROST_MESH
static int nl80211_parse_mesh_eero_ext_config(struct genl_info *info,
				     struct mesh_config *cfg,
				     u32 *mask_out)
{
	struct nlattr *tb[NL80211_MESHCONF_EERO_ATTR_MAX + 1];
	u32 mask = 0;
...
#define FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, param, min, max,		    \
	...
	if (!info->attrs[NL80211_ATTR_MESH_EERO_EXT_CONFIG])
		return -EINVAL;
	if (nla_parse_nested(tb, NL80211_MESHCONF_EERO_ATTR_MAX,
			     info->attrs[NL80211_ATTR_MESH_EERO_EXT_CONFIG],
			     nl80211_meshconf_eero_ext_params_policy))
		return -EINVAL;

	/* This makes sure that there aren't more than 32 mesh eero extension config
	 * parameters (otherwise our bitfield scheme would not work.) */
	BUILD_BUG_ON(NL80211_MESHCONF_EERO_ATTR_MAX > 32);

	/* Fill in the params struct */
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, bifrost_ver, 0, 0xff,
				      mask, NL80211_MESHCONF_EERO_BIFROST_VER,
				      nl80211_check_u8);
	FILL_IN_MESH_BSS_PARAM_IF_SET(tb, cfg, unimcast, 0, 1,
				      mask, NL80211_MESHCONF_EERO_UNIMCAST,
				      nl80211_check_bool);
	if (mask_out)
		*mask_out = mask;
...
#ifdef CONFIG_BIFROST_MESH
	if (tb[NL80211_MESH_SETUP_MESH_ADDR]) {
		memcpy(setup->mesh_addr,
		       nla_data(tb[NL80211_MESH_SETUP_MESH_ADDR]),
		       ETH_ALEN);
	}
#endif
	return 0;
...
#ifdef CONFIG_BIFROST_MESH
static int nl80211_update_mesh_eero_ext_config(struct sk_buff *skb,
				      struct genl_info *info)
{
	struct cfg80211_registered_device *rdev = info->user_ptr[0];
	struct net_device *dev = info->user_ptr[1];
	...
	if (!rdev->ops->update_mesh_eero_ext_config)
		return -EOPNOTSUPP;

	err = nl80211_parse_mesh_eero_ext_config(info, &cfg, &mask);
	if (err)
		return err;
	...
	if (!err)
		err = rdev_update_mesh_eero_ext_config(rdev, dev, mask, &cfg);
...
#ifdef CONFIG_BIFROST_MESH
	/* from upstream patch */
	if (is_zero_ether_addr(setup.mesh_addr))
		memcpy(setup.mesh_addr, dev->dev_addr, ETH_ALEN);
#endif

	if (setup.user_mpm)
#ifdef CONFIG_BIFROST_MESH
		cfg.ifcfg.auto_open_plinks = false;
#else
...
#ifdef CONFIG_BIFROST_MESH
	/* from upstream patch */
	conf.dual = nla_get_u8(info->attrs[NL80211_ATTR_BANDS]);
#else
...
static const struct genl_ops nl80211_ops[] = {
...
#ifdef CONFIG_BIFROST_MESH
	{
		.cmd = NL80211_CMD_NEW_MPP,
		.doit = nl80211_new_mpp,
		.dumpit = nl80211_dump_mpp,
		.policy = nl80211_policy,
		.flags = GENL_UNS_ADMIN_PERM,
		.internal_flags = NL80211_FLAG_NEED_NETDEV_UP |
...
#ifdef CONFIG_BIFROST_MESH
	{
		.cmd = NL80211_CMD_GET_MESH_EERO_EXT_CONFIG,
		.doit = nl80211_get_mesh_eero_ext_config,
		.policy = nl80211_policy,
		/* can be retrieved by unprivileged users */
		.internal_flags = NL80211_FLAG_NEED_NETDEV_UP |
				  NL80211_FLAG_NEED_RTNL,
	...
	{
		.cmd = NL80211_CMD_SET_MESH_EERO_EXT_CONFIG,
		.doit = nl80211_update_mesh_eero_ext_config,
		.policy = nl80211_policy,
		.flags = GENL_UNS_ADMIN_PERM,
		.internal_flags = NL80211_FLAG_NEED_NETDEV_UP |
				  NL80211_FLAG_NEED_RTNL,
...
#ifdef CONFIG_BIFROST_MESH
void nl80211_send_mesh_left(struct wireless_dev *wdev)
{	struct wiphy *wiphy = wdev->wiphy;
	struct cfg80211_registered_device *rdev = wiphy_to_rdev(wiphy);
	struct sk_buff *msg;
	void *hdr;
	...
	hdr = nl80211hdr_put(msg, 0, 0, 0, NL80211_CMD_LEAVE_MESH);
	if (!hdr)
		goto out;
