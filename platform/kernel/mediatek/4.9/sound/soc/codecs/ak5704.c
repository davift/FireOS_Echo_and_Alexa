...
static const struct snd_soc_dapm_widget ak5704_dapm_widgets[] = {
	SND_SOC_DAPM_ADC("ADC1A", NULL, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_ADC("ADC1B", NULL, SND_SOC_NOPM, 1, 0),
	SND_SOC_DAPM_ADC("ADC2A", NULL, SND_SOC_NOPM, 2, 0),
	SND_SOC_DAPM_ADC("ADC2B", NULL, SND_SOC_NOPM, 3, 0),

	SND_SOC_DAPM_MUX("AK5704 ADC1A Enable", SND_SOC_NOPM, 0, 0, &ak5704_adca1sw_mux_control),
	SND_SOC_DAPM_MUX("AK5704 ADC1B Enable", SND_SOC_NOPM, 1, 0, &ak5704_adcb1sw_mux_control),
	SND_SOC_DAPM_MUX("AK5704 ADC2A Enable", SND_SOC_NOPM, 2, 0, &ak5704_adca2sw_mux_control),
	SND_SOC_DAPM_MUX("AK5704 ADC2B Enable", SND_SOC_NOPM, 3, 0, &ak5704_adcb2sw_mux_control),
	...
	SND_SOC_DAPM_ADC("DMIC1A", NULL, SND_SOC_NOPM, 4, 0),
	SND_SOC_DAPM_ADC("DMIC1B", NULL, SND_SOC_NOPM, 5, 0),
	SND_SOC_DAPM_ADC("DMIC2A", NULL, SND_SOC_NOPM, 6, 0),
	SND_SOC_DAPM_ADC("DMIC2B", NULL, SND_SOC_NOPM, 7, 0),

	//MIC BIAS PM
	SND_SOC_DAPM_MICBIAS("Mic1 Power", SND_SOC_NOPM, 4, 0),
	SND_SOC_DAPM_MICBIAS("Mic2 Power", SND_SOC_NOPM, 5, 0),
	...
	SND_SOC_DAPM_SUPPLY("VAD Power", SND_SOC_NOPM, 4, 0, NULL, 0),
...
static int ak5704_set_pllblock(struct snd_soc_codec *codec, int fs)
{
	...
	if (pls) {
		...
		snd_soc_update_bits(codec, AK5704_0C_PLL_FB_CLK_DIVIDER_1, 0xFF, 0);
		snd_soc_update_bits(codec, AK5704_0B_PLL_REF_CLK_DIVIDER_2, 0xFF, 0x27);
		snd_soc_update_bits(codec, AK5704_0D_PLL_FB_CLK_DIVIDER_2, 0xFF, 0x63);
	}
	...
	// Power on mics
	snd_soc_update_bits(codec, AK5704_01_POWER_MANAGEMENT_1,
		AK5704_MIC_POWER_ALL_MASK, AK5704_MIC_POWER_ALL_MASK);
	snd_soc_update_bits(codec, AK5704_02_POWER_MANAGEMENT_2,
		AK5704_MIC_POWER_ALL_MASK, AK5704_MIC_POWER_ALL_MASK);
	// power on programmable filters, set output signal select to filter output
	snd_soc_update_bits(codec, AK5704_03_POWER_MANAGEMENT_3,
				AK5704_MIC_POWER_ALL_MASK,
				AK5704_MIC_POWER_ALL_MASK);
	if (ak5704->pllMode > 0) {
		msleep(5);
...
//Highpass
	snd_soc_update_bits(codec, AK5704_13_ADC_HIGH_PASS_FILTER, 0x7F, 0x70);
