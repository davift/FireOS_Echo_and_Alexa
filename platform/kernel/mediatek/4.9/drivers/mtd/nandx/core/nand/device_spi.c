...
static struct nand_addressing spi_addressing_mx35lf4g = {
	.row_bit_start = 0,
	.block_bit_start = 0,
	.plane_bit_start = 13,
	.lun_bit_start = 0,
...
static struct device_spi spi_nand[] = {
	{
		NAND_DEVICE("W25N01GV",
			    ...
			    3, 0, 3, 3,
			    1, 1, 1, 1024, KB(128), KB(2), 64, 1, false,
	...
	},
	{
		NAND_DEVICE("MT29F4G01ABAFDWB",
			    ...
			    2, 0, 3, 3,
			    1, 1, 1, 2048, KB(256), KB(4), 256, 1, false,
			    &spi_cmds, &spi_addressing, &spi_status[0],
			    &spi_endurance, &spi_array_timing),
		{
			NAND_SPI_PROTECT(0xa0, 1, 2, 6),
	...
	},
	{
		NAND_DEVICE("MX35LF4G24AD",
				NAND_PACK_ID(0xc2, 0x35, 03, 0, 0, 0, 0, 0),
				3, 0, 3, 3,
				1, 1, 2, 1024, KB(256), KB(4), 256, 1, true,
				&spi_cmds, &spi_addressing_mx35lf4g, &spi_status[0],
				&spi_endurance, &spi_array_timing),
		{
			NAND_SPI_PROTECT(0xa0, 1, 2, 6),
			NAND_SPI_CONFIG(0xb0, 4, 6, 1),
