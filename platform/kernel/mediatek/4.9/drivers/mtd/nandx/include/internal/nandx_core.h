...
#define SPI_NAND_DEFAULT_DELAY_MODE 6
#define SPI_NAND_CALIBRATION_CNT 4
...
enum nandx_ctrl_cmd {
	...
	CHIP_CTRL_GET_STATUS,
	CHIP_CTRL_RESET_DEVICE,
	CHIP_CTRL_GET_RESET_CNT,
	CHIP_CTRL_CLR_RESET_CNT
};
...
#define ERASE_MODE 1
#define WRITE_MODE 2
struct nandx_worn_bad_test {
	/* To record simulate page address */
	u32 sim_worn_page_addr;
	u32 sim_op_mode;
};
...
/**
 * nandx_reset_device - reset nand device
 *
 * if device reset success return 0, otherwise return negative error code
 */
int nandx_reset_device(void);
